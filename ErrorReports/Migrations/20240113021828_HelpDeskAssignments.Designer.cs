...
namespace ErrorReports.Migrations
{
    ...
    [Migration("20240113021828_HelpDeskAssignments")]
    partial class HelpDeskAssignments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErrorReports.Areas.Identity.Data.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ErrorReports.Models.ErrorComment", b =>
                {
                    ...
                    b.ToTable("ErrorComment");
                });

            modelBuilder.Entity("ErrorReports.Models.ErrorReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ErrorReports.Models.ErrorComment", b =>
                {
                    ...
                    b.HasOne("ErrorReports.Areas.Identity.Data.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ErrorReports.Areas.Identity.Data.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
